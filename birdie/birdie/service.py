...
from birdie import context
#from birdie import db
from birdie import exception
from birdie.i18n import _, _LE, _LI, _LW
from birdie.common import loopingcall
from birdie.common import service
from birdie import rpc
from birdie import version
from birdie import wsgi
...
service_opts = [
    ...
    cfg.StrOpt('migration_manager',
               default="birdie.server.manager.MigrationManager",
               help='Number of workers for OpenStack Volume API service. '
                    'The default is equal to the number of CPUs available.'),
    cfg.StrOpt('host',
               default="0.0.0.0",
...
def setup_profiler(binary, host):
    if CONF.profiler.profiler_enabled:
        _notifier = osprofiler.notifier.create(
            ...
            rpc.TRANSPORT, "birdie", binary, host)
...
class Service(service.Service):
    ...
    def create(cls, host=None, binary=None, topic=None, manager=None,
        ...
        #manager init
        if not manager:
            subtopic = topic.rpartition('birdie-')[2]
