...
from birdie.api import xmlutil
from birdie import exception
from birdie.i18n import _LE, _LI, _LW
import birdie.policy
...
class ExtensionManager(object):
    ...
    See birdie/tests/api/extensions/foxinsocks/extension.py for an
...
class ControllerExtension(object):
    """Extend core controllers of birdie OpenStack API.

    Provide a way to extend existing birdie OpenStack API core
    controllers.
    """
...
class ResourceExtension(object):
    """Add top level resources to the OpenStack API in birdie."""
...
def extension_authorizer(api_name, extension_name):
    def authorize(context, target=None, action=None):
        ...
        birdie.policy.enforce(context, act, target)
    return authorize
