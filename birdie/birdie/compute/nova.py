...
from birdie import context as ctx
...
class API(object):
    ...
    def get_server(self, context, server_id, privileged_user=False,
        ...
        try:
            server = novaclient(context, privileged_user=privileged_user,
