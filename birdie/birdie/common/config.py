...
core_opts = [
    cfg.StrOpt('api_paste_config',
               ...
               help='File name for the paste.deploy config for birdie-api'),
    cfg.StrOpt('state_path',
               default='/var/lib/birdie',
               deprecated_name='pybasedir',
               help="Top-level directory for maintaining birdie's state"), ]
...
global_opts = [
    ...
    cfg.ListOpt('glance_api_servers',
                ...
                help='A list of the glance API servers available to birdie '
                     '([hostname|ip]:port)'),
    ...
    cfg.ListOpt('osapi_volume_ext_list',
                ...
                help='Specify list of extensions to load when using osapi_'
                     'volume_extension option with birdie.api.contrib.'
                     'select_extensions'),
    cfg.MultiStrOpt('osapi_volume_extension',
                    default=['birdie.api.contrib.standard_extensions'],
    ...
    cfg.StrOpt('rootwrap_config',
               default='/etc/birdie/rootwrap.conf',
    ...
    cfg.StrOpt('volume_api_class',
               default='birdie.volume.cinder.API',
               help='The full class name of the volume API class to use'),
    cfg.StrOpt('backup_api_class',
               default='birdie.backup.api.API',
